...
public class GameManagement {
    ...
    /**
     * This method will draw the whole maze
     * @param gc GraphicsContext to draw the lines
     * @param row
     * @param column
     * @param mazeInfo
     ...
     * @param numOfGrids
     */
	/*public static void drawMaze(GraphicsContext gc, int row, int column, GridData[][] mazeInfo, double side, int numOfGrids){
		displayMaze(gc, mazeInfo, side, numOfGrids);
		drawBorders(gc, side);
		drawGrid(gc, row, column, mazeInfo, side, numOfGrids);
	}*/
